            ...
            while ($d = mysqli_fetch_array($query)) { ?>
              <tr>
                ...
                if (isset($_POST['isi_sidang'])) {
                  ...
                  if ($hasil) {
                    echo '<script language="javascript">alert("Success"); document.location="index.php?menu=tgl_sidang_p";</script>';
                  } else {
                    echo '<script language="javascript">alert("Gagal coy"); document.location="index.php?menu=tgl_sidang_p";</script>';
                  }
                }
                ?>
              </tr>
