              ...
              while ($d = mysqli_fetch_array($query)) { ?>
                <tr>
                  ...
                  if (isset($_POST['isi_hakim'])) {
                    ...
                    if ($hasil) {
                      echo '<script language="javascript">alert("Success"); document.location="index.php?menu=tunjuk_hakim";</script>';
                    } else {
                      echo '<script language="javascript">alert("Gagal coy"); document.location="index.php?menu=tunjuk_hakim";</script>';
                    }
                  }
                  ?>
                </tr>
