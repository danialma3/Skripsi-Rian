...
if ($act == 'del') {
  ...
  $q = mysqli_query($connect, "DELETE FROM tb_permohonan_p WHERE id_permohonan='$id'");
  if ($q) {
    echo '<script language="javascript">alert("Success"); document.location="index.php?menu=permohonan_p";</script>';
  } else {
    echo '<script language="javascript">alert("Gagal"); document.location="index.php?menu=permohonan_p";</script>';
  }
  echo "<script>document.location.href='index.php?menu=permohonan_p'</script>";
} elseif ($act == 'edit') {
  $id = $_GET['id_permohonan'];
            ...
            <tbody>
              ...
              while ($d = mysqli_fetch_array($query)) { ?>
                <tr>
                  ...
                  <!-- AKSI -->
                  <td>
                    <a class="btn btn-sm btn-danger" href="index.php?menu=permohonan_p&act=del&id_permohonan=<?php echo $d['id_permohonan'] ?>"><i class="fa fa-trash"></i> </a>
                          ...
                          <form enctype="multipart/form-data" method="post">
                            <div class="modal-body">
                              <div class="">
                                ...
                                $cek = mysqli_query($connect, "SELECT * FROM tb_permohonan_p Where id_permohonan = $id_p");
...
if (isset($_POST['simpan'])) {
  ...
  $hasil = mysqli_query($connect, "INSERT INTO tb_permohonan_p ()");
  if ($hasil) {
    echo '<script language="javascript">alert("Success"); document.location="index.php?menu=permohonan_p";</script>';
  } else {
    echo '<script language="javascript">alert("Gagal coy"); document.location="index.php?menu=permohonan_p";</script>';
