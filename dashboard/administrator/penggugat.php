  ...
  if ($act == 'del') {
    ...
    $id = $_GET['id_penggugat'];
    $q = mysqli_query($connect, "SELECT * FROM tb_penggugat");
      ...
      <div class="x_panel">
        <div class="x_title">
          <h2><i class="fa fa-user"></i> Data penggugat
            <a class="btn btn-sm btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus"></i> Tambah Data Penggugat</a>
          </h2>
          <div class="clearfix"></div>
        </div>
            ...
            <tbody>
              ...
              while ($d = mysqli_fetch_array($query)) { ?>
                <tr>
                  ...
                  <td><?php echo $d['tmp_lahir_p'] . ', ' . $d['tgl_lahir_p'] ?></td>
                  <td><?php echo $d['alamat_p']; ?></td>
