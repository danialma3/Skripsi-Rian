    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;"><a href="index.php?menu=home" class="site_title"><center><span>- PIMPINAN -</span></center></a>
          </div>
          <div class="clearfix"></div>
          <div class="profile">
            <div class="profile_pic"><img src="../../assets/images/user.png" alt="..." class="img-circle profile_img"></div>
            <div class="profile_info"><span>Welcome,</span><h2><?php echo $nama; ?></h2></div>
          </div>
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu" style="margin-top:100px">
                ...
                <br><h3>Laporan</h3>
                <li><a href="../laporan/laporan_gugatan.php" target="_BLANK"><i class="fa fa-book"></i> Laporan Gugatan</a></li>
                <li><a href="../laporan/laporan_kasasi.php" target="_BLANK"><i class="fa fa-book"></i> Laporan Kasasi</a></li>
                <li><a href="../laporan/laporan_banding.php" target="_BLANK"><i class="fa fa-book"></i> Laporan Banding</a></li>
                <li><a href="../laporan/laporan_eksekusi.php" target="_BLANK"><i class="fa fa-book"></i> Laporan Eksekusi</a></li>
                <li><a href="../laporan/laporan_peninjauan.php" target="_BLANK"><i class="fa fa-book"></i> Laporan Peninjauan Kembali</a></li>
              </ul>
            </div>
          </div>
        </div>
