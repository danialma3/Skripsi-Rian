...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2><i class="fa fa-user"></i> Isi Hasil Kasus Perdata
    ...
    <div class="x_content">
      <div class="table-responsive">
        <table id="datatable" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
            $query = mysqli_query($connect, "SELECT * FROM tb_permohonan_p LEFT JOIN tb_penggugat ON tb_permohonan_p.id_penggugat = tb_penggugat.id_penggugat WHERE id_hakim = $id_hakim ");
            while ($d = mysqli_fetch_array($query)) { ?>
              <tr>
                ...
                if (isset($_POST['isi_hasil'])) {
                  ...
                  // var_dump($tgl_sidang);
                  // die;
                  $hasil = mysqli_query($connect, "UPDATE tb_permohonan_p SET hasil = '$hasilSidang', tgl_putusan = '$tgl_putusan' WHERE id_permohonan = $id_permohonan");
                  if ($hasil) {
