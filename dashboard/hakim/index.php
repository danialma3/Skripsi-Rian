    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;"><a href="index.php?menu=home" class="site_title"><center><span>HAKIM DASHBOARD</span></center></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu" style="margin-top:100px">
                ...
                <li><a href="index.php?menu=hakim"><i class="fa fa-list"></i> Data Hakim</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="right_col" role="main">
      <div class="row">
    	<?php
          ...
          if($menu=="hakim"){include "hakim.php";}
