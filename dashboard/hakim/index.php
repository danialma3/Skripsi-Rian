        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;"><a href="index.php?menu=home" class="site_title">
                <center><span>HAKIM DASHBOARD</span></center>
              </a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu" style="margin-top:100px">
                  ...
                  <li>
                    <a><i class="fa fa-list"></i>Kasus Pidana <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?menu=data_pidana">Master Data Pidana</a></li>
                      <li><a href="index.php?menu=isi_hasil_putusan">Isi Hasil Putusan Pidana</a></li>
                    </ul>
                  </li>
                  <li>
                    <a><i class="fa fa-list"></i>Kasus Perdata <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?menu=data_perdata">Master Data Perdata</a></li>
                      <li><a href="index.php?menu=isi_hasil_putusan_p">Isi Hasil Putusan Perdata</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
        ...
        <div class="right_col" role="main">
          <div class="row">
            ...
            if (isset($_GET['menu'])) {
              ...
              if ($menu == "isi_hasil_putusan") {
                include "pidana/isi_hasil_putusan.php";
              }
              if ($menu == "data_perdata") {
                include "perdata/data_perdata.php";
              }
              if ($menu == "isi_hasil_putusan_p") {
                include "perdata/isi_hasil_putusan_p.php";
              }
              if ($menu == "logout") {
                include "logout.php";
              }
